...
4. Add functionality to place contract order on Kalshi for a given bracket based off predicted temp
5. Add functionality eventually as cron job to leave in background, and determine best time to place orders
